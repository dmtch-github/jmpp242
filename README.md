...
1.сделать слой DAO, где пользователи будут в памяти в списке, как в 2.4.1. Все операции добавления/удаления/извлечения выполняются со списком
...
**Сделано 2021.12.09**
<li>Отладил типы запросов на простых формах</li>
